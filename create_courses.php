...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $course_weight = floatval($_POST['course_weight']);
    $program_id = intval($_POST['program_id']);

     // Use prepared statement to insert data
     $course_sql = "INSERT INTO course (title, description, course_weight, program_id) VALUES (?, ?, ?, ?)";
     $stmt = mysqli_prepare($conn, $course_sql);
     mysqli_stmt_bind_param($stmt, "ssdi", $title, $description, $course_weight, $program_id);
    ...
    if (mysqli_stmt_execute($stmt)) {
        $_SESSION['success_message'] = "Courses created successfully!";
    } else {
...
<div class="page-wrapper chiller-theme toggled">
  ...
  <main class="page-content">
    ...
    <h2 class="text-center mb-4">CREATE COURSES</h2>
    <form id="assign-Courses-form" action="" method="post">
        ...
        <div class="form-group">
            <label for="course_weight">Course Weight:</label>
            <select class="form-control" id="course_weight" name="course_weight" required>
                <option value=""></option>
       ...
       <div class="form-group">
            ...
            <select class="form-control" id="program_id" name="program_id" required>
                <option value=""></option>
                <!-- Options here (e.g., fetched from the programs table) -->
                <?php
