...
if (isset($_GET['assignment_id'])) {
    ...
    // Retrieve submitted assignments for the selected assignment
    $submittedQuery = "SELECT sa.submission_id, sa.student_id, s.first_name, s.last_name, sa.submission_date, sa.score, sa.comments, sa.file_path
...
<div class="container mt-5">
            ...
            <tbody>
                <?php while ($submittedRow = mysqli_fetch_assoc($submittedResult)) { ?>
                    <tr>
                        ...
                        <td><?php echo $submittedRow['score']; ?></td>
                        <td><?php echo $submittedRow['comments']; ?></td>
                        <td>
                            <a href="<?php echo $submittedRow['file_path']; ?>" target="_blank" class="btn btn-success">Download</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
    ...
    <?php } ?>
    <a href="HID.php" class="btn btn-secondary mt-3">Back to Assignments</a>
</div>
</body>
</html>
