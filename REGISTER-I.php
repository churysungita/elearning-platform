...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Insert instructor data into the database with hashed password
    $sql = "INSERT INTO instructor (username, first_name, last_name, password, email) 
    VALUES ('$username', '$first_name', '$last_name', '$hashed_password', '$email')";

    mysqli_query($conn, $sql);

    if (mysqli_query($conn, $sql)) {
        $_SESSION['success_message'] = "Instructor created successfully!";
    } else {
        $_SESSION['error_message'] = "Error creating instructor: " . mysqli_error($conn);
    }

    // Redirect to the admin dashboard after creating the instructor
...
<div class="page-wrapper chiller-theme toggled">
  ...
  <main class="page-content">
    ...
    <!-- Create Instructor Form -->
    <h2 class="text-center mb-4">CREATE INSTRUCTOR</h2>
    <form id="create-instructor-form" action="" method="post">
