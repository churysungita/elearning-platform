...
// Function to generate buttons for each student row
function generateButtons($student_id) {
    $editButton = '<a href="edit_student.php?student_id=' . $student_id . '" class="btn btn-primary btn-sm">Edit</a>';
    $deleteButton = '<a href="delete_student.php?student_id=' . $student_id . '" class="btn btn-danger btn-sm">Delete</a>';
    $viewButton = '<a href="view_student.php?student_id=' . $student_id . '" class="btn btn-info btn-sm">View</a>';
    
    return $editButton . ' ' . $deleteButton . ' ' . $viewButton;
}

// Fetch student data from the database along with program names
$query = "SELECT s.*, p.program_name FROM students s
...
if (mysqli_num_rows($result) > 0) {
    ...
    echo '<th>Email</th>';
    echo '<th>Program Name</th>'; // Display program name instead of program_id
    echo '<th>Year of Study</th>';
    echo '<th>Age</th>';
    echo '<th>Gender</th>';
    echo '<th>Registration No</th>';
    echo '<th>Actions</th>'; // Add a column for buttons
    echo '</tr>';
    echo '</thead>';
    echo '<tbody>';

    // Loop through the records and display them in the table with buttons
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<td>' . generateButtons($row['student_id']) . '</td>'; // Generate buttons
        echo '</tr>';
    }
